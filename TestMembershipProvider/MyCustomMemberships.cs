...
namespace TestMembershipProvider
{
    public class MyCustomMemberships : MembershipProvider
    {
        private SqlDataReader reader;
        private string connectionString = @"Data Source=SEAFOAM;Initial Catalog=userstore;Integrated Security=True";
        private string eventSource = "SQLMembershipProvider";
        private string eventLog = "Application";
        private string exceptionMessage = "An exception occurred. Please check log file.";
        private int newPasswordLength = 8; // Required password length
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            //However, since we don't have access 
            //to a web.config in 10.1 plus server we 
            //need to create these values in code or 
            //read them from ArcGIS Server's security configuration. 
            ...
            if (String.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "Example SQL Membership provider for ArcGIS Server");
            }

            base.Initialize(name, config);

            pApplicationName = GetConfigValue(config["applicationName"], "esriags");
            ...
            if (temp_format == null)
            {
                temp_format = "Hashed"; //When temp_format is "hashed" the EncodePassword method will apply a Machine Key to conceal the password 
            }
        ...
        public override bool ChangePassword(string username, string oldPwd, string newPwd)
        {
            ...
            cmd.Parameters.Add("@Password", SqlDbType.NChar, 255).Value = EncodePassword(newPwd);
            cmd.Parameters.Add("@LastPasswordChangedDate", SqlDbType.DateTime).Value = DateTime.Now;
            cmd.Parameters.Add("@Username", SqlDbType.NChar, 255).Value = username;
            cmd.Parameters.Add("@ApplicationName", SqlDbType.NChar, 255).Value = pApplicationName;
                      ...
                      string newPwdAnswer)
        {
            ...
            cmd.Parameters.Add("@Question", SqlDbType.NChar, 255).Value = newPwdQuestion;
            cmd.Parameters.Add("@Answer", SqlDbType.NChar, 255).Value = EncodePassword(newPwdAnswer);
            cmd.Parameters.Add("@Username", SqlDbType.NChar, 255).Value = username;
            cmd.Parameters.Add("@ApplicationName", SqlDbType.NChar, 255).Value = pApplicationName;
                 ...
                 out MembershipCreateStatus status)
        {
            ...
            if (u == null)
            {
                ...
                cmd.Parameters.Add("@Username", SqlDbType.NChar, 255).Value = username;
                cmd.Parameters.Add("@Password", SqlDbType.NChar, 255).Value = EncodePassword(password); //This encodes the saved users passwords according to the hash
                cmd.Parameters.Add("@Email", SqlDbType.VarChar, 128).Value = email;
                cmd.Parameters.Add("@PasswordQuestion", SqlDbType.NChar, 255).Value = passwordQuestion;
                cmd.Parameters.Add("@PasswordAnswer", SqlDbType.NChar, 255).Value = EncodePassword(passwordAnswer);
                cmd.Parameters.Add("@IsApproved", SqlDbType.Bit).Value = isApproved;
                cmd.Parameters.Add("@Comment", SqlDbType.NChar, 255).Value = "";
        ...
        public override MembershipUserCollection GetAllUsers(int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            using (StreamWriter w = File.AppendText("C:\\Logs\\custom_aspnet_membership_log.txt"))
            {
                Log("GetAllUsers has been called.", w);
            }

            SqlConnection conn = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand("SELECT Count(*) FROM Users WHERE ApplicationName = @ApplicationName;", conn);
            cmd.Parameters.Add("@ApplicationName", SqlDbType.NChar, 255).Value = pApplicationName;
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT PKID, Username, Email, PasswordQuestion," +
                 ...
                 " FROM Users WHERE ApplicationName = @ApplicationName";
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            cmd.Parameters.Add("@ApplicationName", SqlDbType.NVarChar, 256).Value = pApplicationName;
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    ...
                    if (userIsOnline)
                    {
                        ...
                        updateCmd.Parameters.Add("@ApplicationName", SqlDbType.NVarChar, 256).Value = pApplicationName;
        ...
        private MembershipUser GetUserFromReader(SqlDataReader reader)
        {
            using (StreamWriter w = File.AppendText("C:\\Logs\\custom_aspnet_membership_log.txt"))
            {
                Log("GetUserFromReader has been called.", w);
            }

            object providerUserKey = reader.GetValue(0);
            string username = reader.GetString(1);
            string email = reader.GetString(2);
            string passwordQuestion = reader.GetString(3);
        ...
        public override string ResetPassword(string username, string answer)
        {
            ...
            try
            {
                ...
                updateCmd.Parameters.Add("@Password", SqlDbType.NChar, 255).Value = EncodePassword(newPassword);
                updateCmd.Parameters.Add("@LastPasswordChangedDate", SqlDbType.DateTime).Value = DateTime.Now;
                updateCmd.Parameters.Add("@Username", SqlDbType.NChar, 255).Value = username;
                updateCmd.Parameters.Add("@ApplicationName", SqlDbType.NChar, 255).Value = pApplicationName;
        ...
        public override void UpdateUser(MembershipUser user)
        {
            ...
            cmd.Parameters.Add("@Comment", SqlDbType.NChar, 255).Value = user.Comment;
            cmd.Parameters.Add("@IsApproved", SqlDbType.Bit).Value = user.IsApproved;
            cmd.Parameters.Add("@Username", SqlDbType.NChar, 255).Value = user.UserName;
            cmd.Parameters.Add("@ApplicationName", SqlDbType.NChar, 255).Value = pApplicationName;
            ...
            try
            {
                ...
                if (CheckPassword(password, pwd))
                {
                    if (isApproved)
                    {
                        ...
                        SqlCommand updateCmd = new SqlCommand("UPDATE Users SET LastLoginDate = ?" +
                                                                " WHERE Username = ? AND ApplicationName = ?", conn);
        ...
        private string EncodePassword(string password)
        {
            ...
            switch (PasswordFormat)
            {
                ...
                case MembershipPasswordFormat.Hashed:
                    ...
                    //CF6573D7D6C5F398CA0EE8C1F1B1B4ED9026290EE0D0CC389303ADAF9742F52E7D33AF933D820AE6D6B73382E7B,IsolateApps
                    //455C7C41CD437A0C66215FDD225649E9CF82FDEC9A5D07103C99300035DE69C9B69E9319EBFB76A0F9E6313D76EEB465E2170C8B2F2FE462EFB9E369E1499086,IsolateApps
                    
                    hash.Key = HexToByte("455C7C41CD437A0C66215FDD225649E9CF82FDEC9A5D07103C99300035DE69C9B69E9319EBFB76A0F9E6313D76EEB465E2170C8B2F2FE462EFB9E369E1499086");
        ...
        public override MembershipUserCollection FindUsersByName(string usernameToMatch, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            cmd.Parameters.Add("@UsernameSearch", SqlDbType.NChar, 255).Value = usernameToMatch;
            cmd.Parameters.Add("@ApplicationName", SqlDbType.NChar, 255).Value = pApplicationName;
        ...
        public override MembershipUserCollection FindUsersByEmail(string emailToMatch, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            cmd.Parameters.Add("@EmailSearch", SqlDbType.NChar, 255).Value = emailToMatch;
            cmd.Parameters.Add("@ApplicationName", SqlDbType.NChar, 255).Value = ApplicationName;
